...
var w=require('@stdlib/assert-is-plain-object/dist'),b=require('@stdlib/assert-has-own-property/dist'),h=require('@stdlib/ndarray-base-assert-is-index-mode/dist'),T=require('@stdlib/ndarray-index-modes/dist'),l=require('@stdlib/error-tools-fmtprodmsg/dist');function j(e,r){return w(r)?b(r,"mode")&&(e.mode=r.mode,!h(e.mode))?new TypeError(l('null4S',"mode",T().join('", "'),e.mode)):null:new TypeError(l('null2V',r));}f.exports=j
});var g=s(function(P,y){
var E=require('@stdlib/array-base-assert-is-mostly-safe-data-type-cast/dist'),x=require('@stdlib/array-base-assert-is-real-data-type/dist'),O=require('@stdlib/array-base-assert-is-complex-floating-point-data-type/dist'),m=require('@stdlib/assert-is-collection/dist'),V=require('@stdlib/array-base-put/dist'),c=require('@stdlib/array-dtype/dist'),k=require('@stdlib/array-convert/dist'),n=require('@stdlib/error-tools-fmtprodmsg/dist'),C=v(),D=p();function M(e,r,a){var u,o,t,i;if(!m(e))throw new TypeError(n('null2O',e));if(!m(r))throw new TypeError(n('null2y',r));if(!m(a))throw new TypeError(n('null2l',a));if(u=C(),arguments.length>3&&(o=D(u,arguments[3]),o))throw o;if(t=c(e)||"generic",i=c(a)||"generic",!E(i,t))throw new TypeError(n("invalid argument. Third argument cannot be safely cast to the input array data type. Data types: [%s, %s].",i,t));return O(t)&&x(i)&&(a=k(a,t)),V(e,r,a,u.mode)}y.exports=M
